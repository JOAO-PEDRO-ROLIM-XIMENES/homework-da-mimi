...
ordenado <- sort(dados) # a função sort serve para ordenar os dados, onde colocamos o parâmetro (no caso o vetor) em análise


print(ordenado) #exibição comum de resultados
