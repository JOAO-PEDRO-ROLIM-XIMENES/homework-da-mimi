...
# Boxplot 
boxplot(emissoes,
        main = "Boxplot das Emissões Diárias de Gás Poluente", #título do boxplot
        ylab = "Emissões",                                     #nome do eixo vertical
        col = "lightblue",                                     # Cor da caixa
        border = "black",                                      # Cor das bordas
        boxwex = 0.7,                                          # Largura da caixa
        cex.main = 1.0,
        cex.lab = 1.0,
        ylim = c(0, 35)                                        # Define o eixo Y para melhor visualização
)
